...
export default function Card(props) {
    ...
    return (
        <a key={props.cardData.id} className={props.small ? "card card--height-s" : "card"} href={props.cardData.href}>
            ...
            <p className="card__description" dangerouslySetInnerHTML={props.searchQuery ? { __html: addMark(props.cardData.description, props.cardData.description.search(new RegExp(props.searchQuery, "i")), props.searchQuery.length) } : { __html: props.cardData.description, }}></p>
