...
const createCard = (obj) => {
    ...
    let cardIconSprite = makeElement("img", "card__icon-sprite-test")
    cardIconSprite.src = obj.src
    cardIconContainer.append(cardIconSprite)
